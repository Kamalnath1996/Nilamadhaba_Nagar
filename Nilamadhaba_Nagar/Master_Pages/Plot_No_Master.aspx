<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Index.master" AutoEventWireup="true" CodeFile="Plot_No_Master.aspx.cs" Inherits="Master_Pages_Plot_No_Master" %>
    ...
    <div class="row justify-content-center inp-form">
        <div class="col-lg-12">
            <fieldset class="scheduler-border">
                <legend class="scheduler-border"><i class="fa fa-user" style="color: #ffc107;"></i>Plot No Master</legend>
                ...
                <div id="divShow" runat="server" class="col-lg-12 form-group d-flex justify-content-start">
                    <div class="table-responsive tgid" align="center">
                        <asp:GridView ID="grdDetails" Width="50%" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                            ...
                            OnRowCommand="grdDetails_RowCommand" TabIndex="5">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="Plot No">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDesign" CausesValidation="false" Text='<%#Eval("plot_no")%>'
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 form-group">
                        ...
                        <asp:TextBox ID="txtplotno" runat="server" CssClass="form-control" onkeypress="return validation(event);"></asp:TextBox>
                    </div>
