<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Index.master" AutoEventWireup="true" CodeFile="Project_Master.aspx.cs" Inherits="Master_Pages_Project_Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="col-lg-12">
            <fieldset class="scheduler-border">
                <legend class="scheduler-border"><i class="fa fa-user" style="color: #ffc107;"></i>Project Master</legend>
                            ...
                            <asp:GridView ID="grdDetails" Width="50%" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Project">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDesign" CausesValidation="false" Text='<%#Eval("Project")%>'
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 form-group">
                        ...
                        <asp:TextBox ID="txtProjct" runat="server" CssClass="form-control" onkeypress="return validation(event);"></asp:TextBox>
                    </div>
