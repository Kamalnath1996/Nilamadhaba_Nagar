...
public partial class Master_Pages_Project_Master : System.Web.UI.Page
{
    DAL dal = new DAL();
    ...
    public void showDetails()
    {
        ...
        DataSet ds = DAL.GetDataSet("Sp_Project_Master", hashtable);
    ...
    public string fetchData()
    {
        try
        {
            ...
            var userQuery = "select * from Project_Master where id='" + ViewState["id"].ToString() + "'";
            var dataTable = DAL.GetDataTable(userQuery);
            if (dataTable.Rows.Count > 0)
            {

                txtProjct.Text = dataTable.Rows[0]["Project"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (btnSubmit.Text == "Submit")
        {
            ...
            ht.Add("@project", txtProjct.Text.Trim());

            string id = DAL.ExecuteScalar("Sp_Project_Master", ht);
    ...
    protected void grdDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "DeleteN")
        {
            ...
            DAL.ExecuteScalar("Sp_Project_Master", ht);
